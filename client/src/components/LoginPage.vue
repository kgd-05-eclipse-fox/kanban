    ...
    <form class="form">
      ...
      <div class="control" id="signIn">
        ...
        <button
          ...
          class="buttonSignUp btn btn-outline-dark hvr-sweep-to-left">
          Sign Up
        </button>
      </div>
...
export default {
  ...
  methods: {
    ...
    onSuccess(googleUser) {
      ...
      axios
        .post("https://k-a-n-b-a-n.herokuapp.com/googleSignIn", { gToken })
        .then(({ data }) => {
  ...
  data() {
    return {
      ...
      params: {
        client_id:
          "358498963778-71ock3dr38230rt7o30v1bn9251f64li.apps.googleusercontent.com",
      },
      renderParams: {
        width: 250,
        height: 50,
