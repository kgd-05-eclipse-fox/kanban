    ...
    <form class="form">
      ...
      <div class="control" id="signIn">
        <button
          ...
          class="buttonSignIn btn btn-outline-light hvr-sweep-to-right">
          Sign In
        </button>
        <button
          @click.prevent="toRegister"
          class="buttonSignUp btn btn-outline-dark hvr-sweep-to-left text-info">
          Sign Up
        </button>
      </div>
